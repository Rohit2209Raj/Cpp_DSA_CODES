...
class LinkedList{
    ...
    node* middleNode(){
        node* s=head;
        node* f=head;
        while(f!=NULL && f->next!=NULL){ // always check f!=NULL first as if we take other side NULL->next!=NULL will give an error
            s=s->next;
            f=f->next->next;
        }
        return s;
    ...
    node* leftMiddle(){
        node* s=head;
        node* f=head;
        while(f->next->next!=NULL){ // always check f!=NULL first as if we take other side NULL->next!=NULL will give an error
            s=s->next;
            f=f->next->next;
        }
        return s;
